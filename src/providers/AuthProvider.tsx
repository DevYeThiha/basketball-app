...
const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ handleLogout }}>
      <div
        className={clsx(
          "fixed top-0 left-0 w-screen h-screen bg-primary-orange flex justify-center transition-opacity duration-[0.5s] ease-linear z-50",
          isLogin
      ...
      >
        {!loading && (
          <form
            ...
            className={clsx(
              "relative bg-white h-max min-w-[25rem] transition-all duration-[1s] ease-linear py-[2rem] px-[2.5rem] rounded pointer-events-auto",
